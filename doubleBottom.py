...
class doubleBottom(Strategy):
    ...
    def pattern_scanner(self, minima: pd.Series, maxima: pd.Series, frequency: str ='daily') -> list:
        ...
        for i in range(3, len(min_max)):
            ...
            # cond_1: To check b is in minima prices
            cond_1 = B in maxima.values

            # cond_2: To check a,c are in maxima
            ...
            for x in range(0, len(pattern_data)):
                ...
                try:
                    # return the long entry date if price went below the neckline
                     pattern_data.at[x,'confirmation_date'] = data_after_bottom2[data_after_bottom2 > pattern_data.at[x,'neck1_price']].index[0]
                     ...
                     pattern_data.at[x,'time_for_confirmation'] = (pattern_data.at[x,'confirmation_date'] - pattern_data.at[x,'bottom2_date']).days
    ...
    def risk_Manager(self, pattern_data: pd.DataFrame):
        ...
        if len(pattern_data) != 0:
            ...
            for x in range(0, len(pattern_data)):
                ...
                pattern_data.at[x,'top_length'] = round(pattern_data.at[x,'neck1_price'] - pattern_data.at[x,'bottom2_price'] ,2)
