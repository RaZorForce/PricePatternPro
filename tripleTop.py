            ...
            for x in range(0, len(pattern_data)):
                ...
                try:
                    # return the short entry date if price went below the neckline
                     pattern_data.at[x,'confirmation_date'] = data_after_top3[data_after_top3 < pattern_data.at[x,'neck2_price']].index[0]
                     ...
                     pattern_data.at[x,'time_for_confirmation'] = (pattern_data.at[x,'confirmation_date'] - pattern_data.at[x,'top3_date']).days
    ...
    def risk_Manager(self, pattern_data: pd.DataFrame):
        ...
        if len(pattern_data) != 0:
            ...
            for x in range(0, len(pattern_data)):
                ...
                pattern_data.at[x,'top_length'] = round(pattern_data.at[x,'top3_price'] - pattern_data.at[x,'neck2_price'] ,2)
